...
{
    public class ElectroluxRegisterValueViewModel
      : ViewModelBase<MixCmsContext, MixAttributeSetValue, ElectroluxRegisterValueViewModel>
    {
        #region Properties
        ...
        public ElectroluxRegisterValueViewModel() : base()
        {
            IsCache = false;
        }

        public ElectroluxRegisterValueViewModel(MixAttributeSetValue model, MixCmsContext _context = null, IDbContextTransaction _transaction = null) : base(model, _context, _transaction)
        {
            IsCache = false;
        }
